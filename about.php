	...
	<body>
		...
		<div id="aboutHeader">
			<div id="headerDarkDiv" style="background:rgba(0, 0, 0, 0.45);">
				<div id="aboutHeaderContents">
					<p id="aboutP1">EVANESCENT </p>
					<hr>
					<p id="aboutP2">OUR TEAM</p>
				</div>
			</div>
		</div>
		...
		<div id="aboutInfo">
			<div id="aboutTextHolder">
				<!--<img src="/DisplayImgs-Evanescent/teamzoom.png" height="600px" width="1000px"></img>-->
				<?php
			...
			echo "<div id='membersHolder'>";
				...
				while (!feof($file)) {
					...
					echo '<div class="memberDivs" id="memberDivs'.$counter.'"  onmouseover="changeOpacOver(blackDivAbout'.$counter.')" onmouseout="changeOpacOut(blackDivAbout'.$counter.')">
						<img id="memberDivsImg'.$counter.'" src="/Evanescent/JA/'.$members[5].'"/>
						<img id="memberDivsImgA'.$counter.'" src="/Evanescent/JA/'.$members[6].'"/>
